...
class Scalar0D
{
    ...
    */
    ...
    Scalar0D(Domain0D &domain_in, double value_constant_in)
    {
    ...
    Scalar0D(Domain0D &domain_in, std::function<double(double, VectorDouble)> value_function_in, std::vector<Variable1D*> variable_ptr_vec_in)
    {
...
void Scalar0D::set_output(std::string file_out_str)
{
    /*
...
void Scalar0D::output_csv(int ts)
{
    /*
...
VectorDouble Scalar0D::get_neighbor_value(int edid)
{
    /*
