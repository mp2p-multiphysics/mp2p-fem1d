...
class PhysicsTransientConvectionDiffusion : public PhysicsTransientBase
{
    ...
    */
    ...
    )
    {
        ...
        // vector of scalar and variable fields 
        scalar_field_ptr_vec = {derivativecoefficient_field_ptr, diffusioncoefficient_field_ptr, velocity_x_field_ptr, generationcoefficient_field_ptr};
...
BoundaryField* PhysicsTransientConvectionDiffusion::get_boundary_field_ptr()
{
    /*
...
std::vector<ScalarField*> PhysicsTransientConvectionDiffusion::get_scalar_field_ptr_vec()
{
    /*
