...
class PhysicsTransientDiffusion : public PhysicsTransientBase
{
    ...
    */
    ...
    void set_domain(Domain1D &domain_in, Integral1D &integral_in, Scalar1D &derivativecoefficient_in, Scalar1D &diffusioncoefficient_in, Scalar1D &generationcoefficient_in);
    ...
    (
        ...
        Scalar1D *derivativecoefficient_ptr, Scalar1D *diffusioncoefficient_ptr, Scalar1D *generationcoefficient_ptr
    );
...
void PhysicsTransientDiffusion::set_domain(Domain1D &domain_in, Integral1D &integral_in, Scalar1D &derivativecoefficient_in, Scalar1D &diffusioncoefficient_in, Scalar1D &generationcoefficient_in)
{
    /*
...
void PhysicsTransientDiffusion::set_boundary_dirichlet(Domain0D &domain_in, Scalar0D &value_constant_in)
{
    /*
...
void PhysicsTransientDiffusion::set_boundary_neumann(Domain0D &domain_in, Scalar0D &value_flux_in)
{
    /*
