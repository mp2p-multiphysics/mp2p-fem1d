#ifndef PHYSICS_HEATTRANSFERSOLID_STEADY_LINE2
#define PHYSICS_HEATTRANSFERSOLID_STEADY_LINE2
#include <vector>
#include "Eigen/Eigen"
...
class PhysicsHeatTransferSolidSteady : public PhysicsBaseSteady
{
    ...
    // default constructor
    PhysicsHeatTransferSolidSteady()
    {
...
void PhysicsHeatTransferSolidSteady::matrix_fill
(
    Eigen::SparseMatrix<double> &a_mat, Eigen::VectorXd &b_vec, Eigen::VectorXd &x_vec
)
{
...
void PhysicsHeatTransferSolidSteady::matrix_fill_domain
(
    Eigen::SparseMatrix<double> &a_mat, Eigen::VectorXd &b_vec, Eigen::VectorXd &x_vec,
    MeshLine2Struct *mesh_ptr, BoundaryLine2Struct *boundary_ptr, IntegralLine2 *integral_ptr,
    ScalarLine2 *thermalconductivity_ptr, ScalarLine2 *heatgeneration_ptr
...
void PhysicsHeatTransferSolidSteady::set_start_row(int start_row_in)
{
    start_row = start_row_in;
}

std::vector<VariableFieldGroup*> PhysicsHeatTransferSolidSteady::get_variable_field_ptr_vec()
{
