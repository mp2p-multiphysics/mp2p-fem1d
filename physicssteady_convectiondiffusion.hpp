...
class PhysicsSteadyConvectionDiffusion : public PhysicsSteadyBase
{
    ...
    */
    ...
    void set_domain(Domain1D &domain_in, Integral1D &integral_in, Scalar1D &diffusioncoefficient_in, Scalar1D &velocity_x_in, Scalar1D &generationcoefficient_in);
    ...
    (
        ...
        Scalar1D *diffusioncoefficient_ptr, Scalar1D *velocity_x_ptr, Scalar1D *generationcoefficient_ptr
    );
...
void PhysicsSteadyConvectionDiffusion::set_domain(Domain1D &domain_in, Integral1D &integral_in, Scalar1D &diffusioncoefficient_in, Scalar1D &velocity_x_in, Scalar1D &generationcoefficient_in)
{
    /*
...
void PhysicsSteadyConvectionDiffusion::set_boundary_dirichlet(Domain0D &domain_in, Scalar0D &value_constant_in)
{
    /*
...
void PhysicsSteadyConvectionDiffusion::set_boundary_neumann(Domain0D &domain_in, Scalar0D &value_flux_in)
{
    /*
...
)
{
   ...
   for (int indx_d = 0; indx_d < domain_ptr_vec.size(); indx_d++)
   {
        ...
        matrix_fill_domain(delta_a_triplet_vec, b_vec, x_vec, domain_ptr, integral_ptr, diffusioncoefficient_ptr, velocity_x_ptr, generationcoefficient_ptr);
   ...
   for (int indx_d = 0; indx_d < neumann_domain_ptr_vec.size(); indx_d++)
   {
        ...
        matrix_fill_neumann(a_mat, b_vec, x_vec, domain_ptr, value_flux_ptr);
