...
class PhysicsSteadyConvectionDiffusion : public PhysicsSteadyBase
{
    ...
    */
    ...
    // constructor
    PhysicsSteadyConvectionDiffusion(VariableGroup &value_in)
    {
...
)
{
    ...
    */
    ...
    for (int indx_d = 0; indx_d < domain_ptr_vec.size(); indx_d++)
    {
        ...
        matrix_fill_domain(a_trivec, b_vec, x_vec, domain_ptr, integral_ptr, diffusioncoefficient_ptr, velocity_x_ptr, generationcoefficient_ptr);
