...
class PhysicsSteadyDiffusion : public PhysicsSteadyBase
{
    ...
    (
        ...
        VariableFieldGroup &value_field_in, ScalarFieldGroup &diffusioncoefficien_field_in, ScalarFieldGroup &generationcoefficient_field_in
    )
    {
        ...
        diffusioncoefficient_field_ptr = &diffusioncoefficien_field_in;
    ...
    (
        ...
        ScalarLine2 *diffusioncoefficien_ptr, ScalarLine2 *generationcoefficient_ptr
    );
...
)
{
    ...
    for (int indx_d = 0; indx_d < mesh_physics_ptr->mesh_ptr_vec.size(); indx_d++)
    {
        ...
        // get scalar fields
        ScalarLine2 *diffusioncoefficien_ptr = diffusioncoefficient_field_ptr->scalar_ptr_map[mesh_ptr];
        ...
        matrix_fill_domain(a_mat, b_vec, x_vec, mesh_ptr, boundary_ptr, integral_ptr, diffusioncoefficien_ptr, generationcoefficient_ptr);
...
)
{
    ...
    for (int element_did = 0; element_did < mesh_ptr->num_element_domain; element_did++)
    {
        ...
        double diffcoeff_p0 = diffusioncoefficien_ptr->point_value_vec[p0_did];
        double diffcoeff_p1 = diffusioncoefficien_ptr->point_value_vec[p1_did];
