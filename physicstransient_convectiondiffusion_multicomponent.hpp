...
class PhysicsTransientConvectionDiffusionMulticomponent : public PhysicsTransientBase
{
    ...
    (
        ...
        ScalarLine2 *derivativecoefficient_ptr, ScalarLine2 *velocity_x_ptr, ScalarLine2 *diffusioncoefficient_ptr, ScalarLine2 *generationcoefficient_ptr
    );
        ...
        for (int indx_r = 0; indx_r < boundary_physics_ptr_vec.size(); indx_r++)
        {
            ...
            for (auto &key_value : diffusioncoefficient_field_ptr_mat[indx_r])
            {
                ...
                matrix_fill_domain(
                    ...
                    value_field_ptr,
                    derivativecoefficient_ptr, velocity_x_ptr, diffusioncoefficient_ptr, generationcoefficient_ptr
                );
